...
void EmptyLinkFunctionForGeneratedCodeLichRunner_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_LichRunner()
	{
		if (!Z_Registration_Info_UPackage__Script_LichRunner.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_LichRunner_DamageSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_LichRunner_DeathSignature__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_LichRunner(Z_Construct_UPackage__Script_LichRunner, TEXT("/Script/LichRunner"), Z_Registration_Info_UPackage__Script_LichRunner, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x26F13DA3, 0x2CC44166));
